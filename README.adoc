...
------
$ ansible -i inventory/ all -m shell -a "hostname -f"
------
...
$ EXT_NET_CIDR='10.20.20.0/24' EXT_NET_RANGE='start=10.20.20.100,end=10.20.20.200' EXT_NET_GATEWAY='10.20.20.1' bash init-runonce
------
