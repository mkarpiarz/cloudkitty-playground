...
$ service_uuid=$(cloudkitty hashmap service create openstack_nova_limits_vcpus_used -f value | cut -d' ' -f2)
...
[NOTE]
======
To see all metrics gathered by Prometheus, run the following:

-----
$ vagrant ssh
$ curl http://10.10.10.254:9198/metrics
-----
======
